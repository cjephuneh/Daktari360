      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4 md:justify-start md:space-x-10">
          ...
          <nav className="hidden md:flex space-x-10">
            ...
            <Link href="/pharmacists" className="text-base font-medium text-gray-500 hover:text-gray-900">
              For Pharmacists
            </Link>
          </nav>
            ...
            <div className="pt-5 pb-6 px-5">
              ...
              <div className="mt-6">
                <nav className="grid gap-y-8">
                  ...
                  <Link href="/pharmacists" className="text-base font-medium text-gray-900 hover:text-gray-700">
                    For Pharmacists
                  </Link>
                </nav>
              </div>
